<template>
  ...
  <div
    :class="openEditTask ? ' -translate-x-0' : 'translate-x-full'"
  ...
  >
    <div id="top" class="flex flex-col">
      <div class="flex capitalize justify-between mb-3" id="title">
        ...
        <button @click="$emit('closeEditTask')" class="focus:outline-none">
      ...
      <v-checkbox
        v-model="isDepentTask"
        class="capitalize text-sm"
        label="This Task is dependent on another task"
        color="rgba(165, 210, 118, 1)"
      ></v-checkbox>
...
export default defineComponent({
  ...
  setup(props) {
    ...
    const { addTask, newTask, isDepentTask, depentTask } = manageTask();
