  ...
  <div id="content" class="p-5">
    <div id="members-filters" class="flex flex-row items-center justify-between pb-5">
      <div class="flex flex-row items-center justify-between pb-5 w-full" id="filter">
        <div class="text-xs">
          <v-checkbox class="capitalize text-sm" label="Time Clock changes need to be approved" color="rgba(165, 210, 118, 1)"></v-checkbox>
          <!-- <button
            @click="openAttendance = !openAttendance"
            class="bg-white bor border border-DPGREEN-500 border-dplgreen-400 border-solid flex focus:outline-none hover:bg-DPGREEN-500 hover:duration-200 hover:text-white items-center px-3 py-2 rounded-lg text-xs"
            style="min-width: 110px;"
          >
            <img
              src="~/assets/images/icon-add-user.svg"
              class="bg-DPGREEN-200 mr-1 p-1 rounded-lg w-5"
            />
            Mark Attendance
          </button> -->
        </div>
