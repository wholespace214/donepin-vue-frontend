<template>
  <div id="content" class="p-5">
      ...
      >
        <div class="capitalize">
          <button
            ...
            class="bg-white bor border capitalize border-DPGREEN-500 border-dplgreen-400 border-solid flex focus:outline-none hover:bg-DPGREEN-500 hover:duration-200 hover:text-white items-center px-3 py-2 rounded-lg text-xs"
    ...
    <AdminPaymentsModalAddPayment
      :openPayments="openModal"
