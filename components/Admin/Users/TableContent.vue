    ...
    <Div class="" id="table-body">
      ...
      >
        <Div class="flex items-center" id="table-left">
          ...
          <Div
            id="company-name"
            class="p-2 w-48 capitalize flex-wrap md:flex md:items-center hidden"
          >
            <span
          ...
          <Div
            id="registration"
            class="p-2 w-32 md:flex md:items-center hidden"
          >
            <Span class="text-small capitalize">
              02.05.2021 - 12:45
            </Span>
          </Div>
          <Div id="last-login" class="p-2 w-32 md:flex items-center hidden">
            <Span class="text-small capitalize">
              212.45.411.11
            </Span>
          </Div>
          ...
          <Div id="email" class="p-2 w-24 md:flex md:items-center hidden">
            <Span
...
import TableAdminUsers from "~/data_component/Admin/TableAdminUsers";

export default defineComponent({
  components: { draggable },
  setup() {
    const { tableHead } = TableAdminUsers();
